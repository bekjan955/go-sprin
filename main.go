...
func (w Walking) Calories() float64 {
	...
	return (CaloriesWeightMultiplier*w.Weight + (speedMsec*speedMsec/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
...
// TrainingInfo возвращает информацию о тренировке плавания.
// Это переопределенный метод TrainingInfo() из Training.
